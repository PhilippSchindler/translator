...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "translator@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "translator API";

        private String description = "translator API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "translator";
