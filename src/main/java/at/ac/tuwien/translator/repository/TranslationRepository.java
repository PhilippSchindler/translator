...
public interface TranslationRepository extends JpaRepository<Translation,Long> {
    ...
    @Query("select distinct translation from Translation translation left join fetch translation.language")
    List<Translation> findAllWithEagerRelationships();

    @Query("select translation from Translation translation left join fetch translation.language where translation.id =:id")
