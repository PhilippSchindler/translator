...
import at.ac.tuwien.translator.service.dto.UserDTO;
...
public class AccountResourceIntTest {
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities()).doesNotContain(
            authorityRepository.findOne(AuthoritiesConstants.ADMIN)
        );
//
